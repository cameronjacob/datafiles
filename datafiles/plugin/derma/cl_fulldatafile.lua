...
function PANEL:Init()
    ...
    self.dMiddleButton:SetText("CIVIL STATUS");
    self.dMiddleButton:Dock(LEFT);
	self.dMiddleButton:SetWide(100);

    self.dEmploymentButton = vgui.Create("cwDfButton", self.dButtons);
    self.dEmploymentButton:SetText("EMPLOYMENT");
    self.dEmploymentButton:Dock(RIGHT);
	self.dEmploymentButton:SetWide(100);
	self.dEmploymentButton:SetZPos( 0 )
	self.dEmploymentButton:SetMetroColor(colours.yellow);

    self.dRightButton = vgui.Create("cwDfButton", self.dButtons);
    self.dRightButton:SetText("ADD BOL");
    self.dRightButton:Dock(RIGHT);
	self.dRightButton:SetZPos( -1 )
...
function PANEL:PopulateGenericData(target, datafile, GenericData)
    ...
    self.dMiddleButton.DoClick = function()
        ...
        self.Menu:AddOption("Working Class", function()
            cwDatafile:UpdateCivilStatus(target, "Working Class");
        end):SetImage("icon16/briefcase.png");

        self.Menu:AddSpacer();

        self.Menu:AddOption("Middle Class", function()
            cwDatafile:UpdateCivilStatus(target, "Middle Class");
        end):SetImage("icon16/user_gray.png");

        self.Menu:AddOption("Upper Class", function()
            cwDatafile:UpdateCivilStatus(target, "Upper Class");
	...
	--Employment button
    self.dEmploymentButton.DoClick = function()
        self.Menu = DermaMenu();

        self.Menu:AddOption("Overwatch Transhuman Arm", function()
            cwDatafile:UpdateEmploymentStatus(target, "Overwatch Transhuman Arm");
        end):SetImage("icon16/flag_red.png");

        self.Menu:AddSpacer();
		
        self.Menu:AddOption("Civil Protection", function()
            cwDatafile:UpdateEmploymentStatus(target, "Civil Protection");
        end):SetImage("icon16/user_gray.png");

        self.Menu:AddSpacer();
		
        self.Menu:AddOption("Chamber of Binders", function()
            cwDatafile:UpdateEmploymentStatus(target, "Chamber of Binders");
        end):SetImage("icon16/user_orange.png");

        self.Menu:AddOption("Civil Medical Union", function()
            cwDatafile:UpdateEmploymentStatus(target, "Civil Medical Union");
        end):SetImage("icon16/user_red.png");

        self.Menu:AddOption("Citizen", function()
            cwDatafile:UpdateEmploymentStatus(target, "Citizen");
        end):SetImage("icon16/user_suit.png");

        self.Menu:AddOption("Biotic", function()
            cwDatafile:UpdateEmploymentStatus(target, "Biotic");
...
function PANEL:MakeMedical(bMedical)
    if (bMedical) then
        self.Header1:Remove();
		self.Header2:Remove();
		self.Header3:SetContentAlignment(4);
		self.Header3:DockMargin(7, 0, 0, 0);
	end;
end;
...
function PANEL:Init()
    ...
    self.MiddleHeaderEmploymentLabel = vgui.Create("DLabel", self);
    self.MiddleHeaderEmploymentLabel:SetText("EMPLOYMENT");
    self.MiddleHeaderEmploymentLabel:SetContentAlignment(4)
    self.MiddleHeaderEmploymentLabel:SetTextColor(Color(172, 174, 39, 255));
    self.MiddleHeaderEmploymentLabel:SetFont("TopBoldLabel");
    self.MiddleHeaderEmploymentLabel:Dock(FILL);
    self.MiddleHeaderEmploymentLabel:DockMargin(207, 5, 0, 0);
	
    self.MiddleHeaderLabel = vgui.Create("DLabel", self);
    self.MiddleHeaderLabel:SetText("POINTS");
    self.MiddleHeaderLabel:SetContentAlignment(6)
    ...
    self.MiddleHeaderLabel:DockMargin(0, 5, 207, 0);
    ...
    self.MiddleTextEmploymentLabel = vgui.Create("DLabel", self.TextPanel);
    self.MiddleTextEmploymentLabel:SetTextColor(Color(220, 220, 220, 255));
    self.MiddleTextEmploymentLabel:SetContentAlignment(4)
    self.MiddleTextEmploymentLabel:Dock(FILL);
    self.MiddleTextEmploymentLabel:DockMargin(207, 5, 5, 5);

    self.MiddleTextLabel = vgui.Create("DLabel", self.TextPanel);
    self.MiddleTextLabel:SetTextColor(Color(0, 0, 0, 255));
    self.MiddleTextLabel:SetContentAlignment(6)
    self.MiddleTextLabel:Dock(FILL);
    self.MiddleTextLabel:DockMargin(5, 5, 207, 5);
...
function PANEL:SetInfoText(leftBottom, middleBottomEmployment, middleBottom, rightBottom)
    self.LeftTextLabel:SetText(leftBottom);
	self.MiddleTextEmploymentLabel:SetText(middleBottomEmployment);
...
function PANEL:MakeMedical(bMedical)
    if (bMedical) then
		self.MiddleHeaderEmploymentLabel:DockMargin(147, 5, 0, 0);
		self.MiddleHeaderLabel:DockMargin(0, 5, 122, 0);
		self.MiddleTextLabel:DockMargin(5, 5, 146, 5);
		self.MiddleTextEmploymentLabel:DockMargin(147, 5, 5, 5);
	end;
end;
