...
function PANEL:Init()
	...
	self.uRightButton = vgui.Create("cwDfButton", self.dButtons);
...
function PANEL:PopulateDatafile(target, datafile)
	for k, v in pairs(datafile) do
        ...
        if (datafile[k].category == "med") then
...
vgui.Register("cwMedicalDatafile", PANEL, "DFrame");