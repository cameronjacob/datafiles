...
function PANEL:Populate(cwuobjectives)
	self:SetTitle("CWU Objectives");
	...
	textEntry:SetText(cwuobjectives);
	...
	function button.DoClick(button)
		Clockwork.datastream:Start("EditCwuObjectives", string.sub(textEntry:GetValue(), 0, 500));
		net.Start("ObjectivesPanelClosed")
		net.WriteInt( 0, 3 ) 
		net.SendToServer()		
		self:Close(); self:Remove();
...
vgui.Register("cwCwuObjectives", PANEL, "DFrame");