...
Clockwork.datastream:Hook("DrawMedicalpad", function(dataob)
...
Button2.DoClick = function()
	...
	LocalPlayer():ConCommand( "cwSay /ViewCMUObjectives" )
	FrameDP:Close()
end
...
Button4.DoClick = function()
	...
	FrameDP:Close()
	LocalPlayer():ConCommand( "cwSay /medpda" )
	...
	LocalPlayer():ConCommand( "cwSay /closemedpda" )
	FrameDP:Close()
	end
	Clockwork.option:PlaySound("click");
end
...
concommand.Add( "cw_medpda", function( ply, cmd, args )
	ply:ConCommand( "cwSay /medpda" )
end )


Clockwork.datastream:Hook("EditMedicalObjectives", function(data)
	if (Schema.MedicalobjectivesPanel and Schema.MedicalobjectivesPanel:IsValid()) then
		Schema.MedicalobjectivesPanel:Close();
		Schema.MedicalobjectivesPanel:Remove();
	end;
	
	Schema.MedicalobjectivesPanel = vgui.Create("cwMedicalObjectives");
	Schema.MedicalobjectivesPanel:Populate(data or "");
	Schema.MedicalobjectivesPanel:MakePopup();
